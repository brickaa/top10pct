...
(function() {
  ...
  var maxTextHeight = Math.max.apply(null, $('.charts--explainer_text')
    .map(function () { return $(this).height(); }).get());

  var explainerBox = $('#charts--explainer_box');
  ...
  // for (var i = 1; i < 6; i++) {
  //   explainerTexts.push('explainer' + i);
  // }

  // explainerTexts.forEach(function(x) {
  //   console.log(x);
  // });
